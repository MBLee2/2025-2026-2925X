...
void blue_positive_half_wp(){ //Almost Done
  ...
  liftPneumaticUp();
  pros::delay(200);
  chassis.moveToPoint(20, temp_pos2, 1500, {.forwards = false,.maxSpeed=70});
  chassis.waitUntil(10);
  liftPneumaticDown();
  pros::delay(200);
  liftIntake();
  chassis.moveToPoint(7, 50, 1500, {.maxSpeed = 60});     
  spinIntake(127);
  saveRings(2000);
  ...
  chassis.turnToPoint(46, 24, 2000, {.maxSpeed = speed,.minSpeed = 20, .earlyExitRange = 8});
  chassis.moveToPoint(46, 24, 2000, {.minSpeed = 30, .earlyExitRange = 2});
  pros::delay(1000);  
  autoIntake = true;
  chassis.waitUntil(22);
  printPositionV2((char *) "2nd Ring");

  chassis.turnToHeading(45, 2000,{.maxSpeed = speed,.minSpeed = 20, .earlyExitRange = 8});
  chassis.moveToPoint(49, 56, 2000, {.maxSpeed = speed1,.minSpeed = 30, .earlyExitRange = 2});
  spinIntake(127);
  ...
  chassis.moveToPoint(temp_pos1+1, temp_pos2+1, 1500,{.forwards=false,.maxSpeed=40,.minSpeed = 20, .earlyExitRange = 8},false);
  liftIntake();
  pros::delay(200);
  ...
  pros::delay(400);
  //*/
  chassis.turnToPoint(11, 15, 3000, {.maxSpeed = speed,.minSpeed = 20, .earlyExitRange = 8});
  chassis.moveToPoint(7, 22, 3000, {.maxSpeed = speed1});
  //*/
  master.clear_line(0);
  int temp = pros::millis();
  while (true) {
...
void auton_60s_skills_1() {
  ...
  chassis.moveToPoint(48, 0, 3000, {.maxSpeed = speed, .minSpeed = speed - 30, .earlyExitRange = 3});

  chassis.moveToPoint(27, 24, 2000, {.maxSpeed = speed});
  hoodFwd();
  redirectRings();
  chassis.turnToPoint(0, 48, 1000, {.forwards = false, .maxSpeed = (int)max_speed - 4, .earlyExitRange = 0.5});
  printPosition((char *)"3rd Basket", false);
  chassis.moveToPoint(3, 51, 2000, {.forwards = false, .maxSpeed = speed});
  chassis.waitUntil(35);
  closeClamp();
  printPosition((char *)"3rd Goal", false);

  chassis.turnToHeading(0, 1000, {.maxSpeed = (int)max_speed - 4, .earlyExitRange = 0.5});
  ...
  pros::delay(50);
  chassis.moveToPoint(currentPose.x - 2, 58, 1000, {.maxSpeed = speed}, false);
  ...
  chassis.turnToPoint(-48, 48, 1000, {.maxSpeed = (int) speed, .earlyExitRange = 0.5});
  spinIntake(127);
  hoodBwd();
  autoIntake = true;
  ...
  chassis.turnToPoint(48, 48, 3000, {.maxSpeed = (int) speed, .earlyExitRange = 0.5});
  chassis.moveToPoint(48, 48, 4000, {.maxSpeed = speed});
  chassis.turnToPoint(60, 48, 2000, {.maxSpeed = (int) speed, .earlyExitRange = 0.5});
  chassis.waitUntil(90);
  currentPose = chassis.getPose();
  ...
  printPosition((char *)"6th Ring", false);
  extendSweep();
  chassis.turnToPoint(72, 65, 2000, {.maxSpeed = (int) speed, .earlyExitRange = 0.5});
  stopIntake();
