...
auton_routine positive_WP{0, 0, 0, "None - Invalid Routine", &positiveSmart};
...
void redPositiveHalfWP(){
  ...
  chassis.setPose(16.2,-57.3,230);
  chassis.moveToPoint(13, -58, 1000,{.maxSpeed=speed1,.minSpeed=15,.earlyExitRange=1});
  chassis.waitUntil(5);
  moveLiftToPos(660, 127, 800);
  temp_pos = chassis.getPose();
  chassis.moveToPoint(22, -52, 1000,{.forwards = false, .maxSpeed = 127});
  chassis.turnToHeading(-58, 1000,{.maxSpeed = speed,.minSpeed = 20, .earlyExitRange = 2});
  moveToReset(127);
  pros::Task pressure([=] {
    while(autoLift){
      spinLift(-30);
  ...
  chassis.moveToPoint(18.5, -52.5, 1000,{.maxSpeed = 127,.minSpeed = 50,.earlyExitRange=0.25},false);
  extendLeftSweeper();
  printPosition((char *) "Sweeper");
  pros::delay(200);
  chassis.turnToPoint(26,-20,1500,{.forwards=false,.maxSpeed = speed,.minSpeed = 5, .earlyExitRange = 1});
  chassis.moveToPoint(26,-20,1100,{.forwards=false,.maxSpeed = speed1,.minSpeed = 5, .earlyExitRange = 1},false);
  spinIntake(127);
  startSorting();
  closeClamp();
  chassis.cancelAllMotions();
  chassisWithGoal.turnToHeading(120, 1000,{.maxSpeed = 127,.minSpeed = 25,.earlyExitRange = 1}, false);
  retractLeftSweeper(); 
  chassisWithGoal.turnToHeading(90, 400,{.maxSpeed = 127,.minSpeed = 25, .earlyExitRange = 2}, false);
  /////////////THIRD RING/////////////
  moveToPointWithVis(46, -22, 2000, {.maxSpeed = 50, .xLimit = 36, .yLimit = -26, .driveThrough = true, .keepDriving = false});
  chassisWithGoal.moveToPoint(55,-22,1000,{.maxSpeed = speed1 - 15,.minSpeed=25,.earlyExitRange=2}, false);
  ////////////CORNER RINGS/////////////
  chassisWithGoal.turnToHeading(150, 1500, {.maxSpeed = 50, .minSpeed = 15, .earlyExitRange = 1});
  chassisWithGoal.moveToPoint(65, -44, 1500, {.maxSpeed = speed1, .minSpeed = 25, .earlyExitRange = 2}, false);
  turnToHeadingWithVis(150,1200, 40,{.maxSpeed = speed1}, 150);
  pros::delay(50);
  extendLeftSweeper();
  chassisWithGoal.turnToHeading(chassisWithGoal.getPose().theta - 5, 1000, {.maxSpeed = speed, .minSpeed = speed - 20, .earlyExitRange = 1}, false);
  moveToPointWithVis(57, -60, 1000, {.maxSpeed = 80, .yLimit = -55, .keepDriving = true});
  //chassisWithGoal.turnToHeading(270, 3000, {.direction = lemlib::AngularDirection::CW_CLOCKWISE,.maxSpeed = 30, .minSpeed = 30, .earlyExitRange = 3}, false);
  chassisWithGoal.turnToHeading(315, 1000, {.maxSpeed = speed + 50, .minSpeed = 15, .earlyExitRange = 2}, false);
  retractLeftSweeper();
  moveToPointWithVis(24, -60, 14000 - (pros::millis() - time), {.maxSpeed = 70, .xLimit = 10, .yLimit = -24, .driveThrough = true, .keepDriving = true});
  printf("Time before ladder: %d\n", pros::millis() - time);
  /***************TOUCH LADDER**************/
  chassisWithGoal.turnToPoint(18, -15, 1500, {.maxSpeed = speed, .minSpeed=15,.earlyExitRange=1});
  //chassisWithGoal.moveToPoint(27, 23, 1500, {.maxSpeed = speed1,.minSpeed=25,.earlyExitRange=2});
  chassisWithGoal.moveToPoint(18, -18, 1500, {.maxSpeed = 127,.minSpeed=25,.earlyExitRange=1});
...
void bluePositiveHalfWP(){//PATH DONE
  ...
  chassis.setPose(16.2,57.3,310);
  chassis.moveToPoint(13, 58, 1000,{.maxSpeed=speed1,.minSpeed=15,.earlyExitRange=1});
  chassis.waitUntil(5);
  moveLiftToPos(660, 127, 800);
  temp_pos = chassis.getPose();
  chassis.moveToPoint(22, 54, 1500,{.forwards = false, .maxSpeed = 127,.minSpeed=30,.earlyExitRange=3});
  chassis.turnToHeading(270, 1000,{.maxSpeed = speed,.minSpeed = 15, .earlyExitRange = 2});
  pros::Task pressure([=] {
    moveToReset(127);
    while(autoLift){
      spinLift(-30);
  ...
  chassis.moveToPoint(17, 54, 1500,{.maxSpeed = 127,.minSpeed = 50,.earlyExitRange=2},false);
  extendLeftSweeper();
  printPositionV2((char *) "sweeper", false, false, time);
  pros::delay(100);
  /////////////GOAL GRAB//////////////
  chassis.turnToPoint(24,24,1500,{.forwards=false,.maxSpeed = speed,.minSpeed = 5, .earlyExitRange = 1});
  spinIntake(127);
  startSorting();
  chassis.moveToPoint(24,25.5,1100,{.forwards=false,.maxSpeed = speed1,.minSpeed = 5, .earlyExitRange = 1}, false);
  closeClamp();
  chassis.cancelAllMotions();
  chassisWithGoal.turnToHeading(115, 1000,{.maxSpeed = 127,.minSpeed = 25,.earlyExitRange = 1}, false);
  retractLeftSweeper(); 
  chassisWithGoal.turnToHeading(90, 400,{.maxSpeed = 127,.minSpeed = 25, .earlyExitRange = 2}, false);
  /////////////THIRD RING/////////////
  moveToPointWithVis(57, 22, 2000, {.maxSpeed = 50, .xLimit = 57, .driveThrough = true});
  chassisWithGoal.moveToPoint(57, 24, 1500, {.maxSpeed = speed1, .minSpeed = 15, .earlyExitRange = 2});

  ////////////CORNER RINGS/////////////
  chassisWithGoal.turnToPoint(32, 54, 1000, {.maxSpeed=speed - 30,.minSpeed=5,.earlyExitRange=1});
  chassisWithGoal.moveToPoint(32,52,1500,{.maxSpeed = speed1,.minSpeed=25,.earlyExitRange=2}, false);
  chassisWithGoal.turnToPoint(69, 69, 1500, {.maxSpeed = speed, .minSpeed = 5, .earlyExitRange = 1});
  chassisWithGoal.moveToPoint(48, 62, 1500, {.maxSpeed = speed1, .minSpeed = 15, .earlyExitRange = 2});
  turnToHeadingWithVis(60,1200, 50,{.maxSpeed = speed1});
  pros::delay(50);
  extendLeftSweeper();
  temp_pos = chassisWithGoal.getPose();
  chassisWithGoal.turnToHeading(temp_pos.theta - 5, 1000, {.maxSpeed = speed, .minSpeed = speed - 20, .earlyExitRange = 1});
  moveToPointWithVis(55, 60, 700, {.maxSpeed = 80, .xLimit = 57, .keepDriving = true});
  chassisWithGoal.turnToHeading(180, 1000, {.maxSpeed = 127, .minSpeed = 73, .earlyExitRange = 3}, false);
  chassisWithGoal.turnToHeading(160, 1000, {.maxSpeed = speed, .minSpeed = 15, .earlyExitRange = 2}, false);
  retractLeftSweeper();
  moveToPointWithVis(60, 36, 14200 - (pros::millis() - time), {.maxSpeed = 75, .yLimit = 12, .driveThrough = true, .keepDriving = true});
  printf("Time before ladder: %d\n", pros::millis() - time);
  
  /***************TOUCH LADDER**************/
  chassisWithGoal.turnToPoint(15, 15, 1500, {.maxSpeed = speed - 20, .minSpeed=15,.earlyExitRange=1});
  chassisWithGoal.moveToPoint(17, 15, 1500, {.maxSpeed = speed1});
...
void bluePositiveHalfWPDelayed(){//PATH DONE
  int time = pros::millis();
  int speed = 110;
  float speed1 = float(speed);
  lemlib::Pose temp_pos = chassis.getPose();
  ...
  pros::delay(100);
  /////////////GOAL GRAB//////////////
  chassis.turnToPoint(24,24,1500,{.forwards=false,.maxSpeed = 70,.minSpeed = 5, .earlyExitRange = 1});
  spinIntake(127);
  startSorting();
  chassis.moveToPoint(24,25.5,1100,{.forwards=false,.maxSpeed = 70,.minSpeed = 5, .earlyExitRange = 1}, false);
  closeClamp();
  chassis.cancelAllMotions();
  chassisWithGoal.turnToHeading(115, 1000,{.maxSpeed = 127,.minSpeed = 25,.earlyExitRange = 1}, false);
  retractLeftSweeper(); 
  chassisWithGoal.turnToHeading(90, 400,{.maxSpeed = 127,.minSpeed = 25, .earlyExitRange = 2}, false);
  /////////////THIRD RING/////////////
  moveToPointWithVis(57, 22, 2000, {.maxSpeed = 90, .xLimit = 57, .driveThrough = true});
  chassisWithGoal.moveToPoint(57, 24, 1500, {.maxSpeed = speed1, .minSpeed = 15, .earlyExitRange = 2});

  ////////////CORNER RINGS/////////////
  chassisWithGoal.turnToPoint(32, 54, 1000, {.maxSpeed= 90,.minSpeed=5,.earlyExitRange=1});
  chassisWithGoal.moveToPoint(32,52,1500,{.maxSpeed = 127,.minSpeed=25,.earlyExitRange=2}, false);
  chassisWithGoal.turnToPoint(69, 69, 1500, {.maxSpeed = 127, .minSpeed = 5, .earlyExitRange = 1});
  chassisWithGoal.moveToPoint(48, 62, 1500, {.maxSpeed = 127, .minSpeed = 15, .earlyExitRange = 2});
  turnToHeadingWithVis(60,1200, 50,{.maxSpeed = 127});
  pros::delay(50);
  extendLeftSweeper();
  temp_pos = chassisWithGoal.getPose();
  chassisWithGoal.turnToHeading(temp_pos.theta - 5, 1000, {.maxSpeed = 127, .minSpeed = speed - 20, .earlyExitRange = 1});
  moveToPointWithVis(55, 60, 700, {.maxSpeed = 90, .xLimit = 55, .keepDriving = true});
  chassisWithGoal.turnToHeading(180, 1000, {.maxSpeed = 127, .minSpeed = 73, .earlyExitRange = 3}, false);
  chassisWithGoal.turnToHeading(160, 1000, {.maxSpeed = speed, .minSpeed = 15, .earlyExitRange = 2}, false);
  retractLeftSweeper();
  moveToPointWithVis(60, 36, 14200 - (pros::millis() - time), {.maxSpeed = 100, .yLimit = 22, .driveThrough = true, .keepDriving = true});
  printf("Time before ladder: %d\n", pros::millis() - time);
...
void redPositiveHalfWPDelayed(){
  ...
  printPosition((char *) "Sweeper");
  pros::delay(100);
  chassis.turnToPoint(26,-20,1500,{.forwards=false,.maxSpeed = 70,.minSpeed = 5, .earlyExitRange = 1});
  chassis.moveToPoint(26,-20,1100,{.forwards=false,.maxSpeed = 70,.minSpeed = 5, .earlyExitRange = 1},false);
  spinIntake(127);
  startSorting();
  closeClamp();
  chassis.cancelAllMotions();
  ...
  chassisWithGoal.turnToHeading(90, 400,{.maxSpeed = 127,.minSpeed = 25, .earlyExitRange = 2}, false);
  /////////////THIRD RING/////////////
  moveToPointWithVis(46, -22, 2000, {.maxSpeed = 100, .xLimit = 36, .yLimit = -26, .driveThrough = true, .keepDriving = false});
  chassisWithGoal.moveToPoint(55,-22,1000,{.maxSpeed = speed1,.minSpeed=25,.earlyExitRange=2}, false);
  ////////////CORNER RINGS/////////////
  chassisWithGoal.turnToHeading(150, 1500, {.maxSpeed = 90, .minSpeed = 15, .earlyExitRange = 1});
  chassisWithGoal.moveToPoint(65, -44, 1500, {.maxSpeed = 127, .minSpeed = 25, .earlyExitRange = 2}, false);
  turnToHeadingWithVis(150,1200, 40,{.maxSpeed = 127}, 150);
  pros::delay(50);
  extendLeftSweeper();
  chassisWithGoal.turnToHeading(chassisWithGoal.getPose().theta - 5, 1000, {.maxSpeed = 127, .minSpeed = speed - 20, .earlyExitRange = 1}, false);
  moveToPointWithVis(57, -60, 1000, {.maxSpeed = 90, .yLimit = -54, .keepDriving = true});
  //chassisWithGoal.turnToHeading(270, 3000, {.direction = lemlib::AngularDirection::CW_CLOCKWISE,.maxSpeed = 30, .minSpeed = 30, .earlyExitRange = 3}, false);
  chassisWithGoal.turnToHeading(315, 1000, {.maxSpeed = speed + 50, .minSpeed = 15, .earlyExitRange = 2}, false);
  retractLeftSweeper();
  moveToPointWithVis(24, -60, 14200 - (pros::millis() - time), {.maxSpeed = 100, .xLimit = 13, .yLimit = -24, .driveThrough = true, .keepDriving = true});
  printf("Time before ladder: %d\n", pros::millis() - time);
  /***************TOUCH LADDER**************/
  chassisWithGoal.turnToPoint(18, -15, 1500, {.maxSpeed = speed, .minSpeed=15,.earlyExitRange=1});
  //chassisWithGoal.moveToPoint(27, 23, 1500, {.maxSpeed = speed1,.minSpeed=25,.earlyExitRange=2});
...
void delayedPositiveHalfWp(){
  int time = pros::millis();
  if(COLOR){
    redPositiveHalfWPDelayed();
  } else {
    bluePositiveHalfWPDelayed();
  }
...
void bluePositiveWPStake(){//PATH DONE  
  ...
  chassis.setPose(16.2,57.3,310);
  chassis.moveToPoint(13, 58, 1200,{.maxSpeed=speed1,.minSpeed=15,.earlyExitRange=1});
  chassis.waitUntil(5);
  moveLiftToPos(660, 127, 800);
  temp_pos = chassis.getPose();
  chassis.moveToPoint(22, 54, 1500,{.forwards = false, .maxSpeed = 127,.minSpeed=30,.earlyExitRange=3});
  ...
  chassisWithGoal.turnToHeading(115, 1000,{.maxSpeed = 127,.minSpeed = 25,.earlyExitRange = 1}, false);
  retractLeftSweeper(); 
  chassisWithGoal.turnToHeading(90, 400,{.maxSpeed = 127,.minSpeed = 25, .earlyExitRange = 2});
  /////////////THIRD RING/////////////
  moveToPointWithVis(57, 22, 2000, {.maxSpeed = 80, .xLimit = 57, .driveThrough = true});
  chassisWithGoal.moveToPoint(57, 24, 1500, {.maxSpeed = speed1 - 15, .minSpeed = 15, .earlyExitRange = 2});

  ////////////CORNER RINGS/////////////
  chassisWithGoal.turnToPoint(48, 48, 1500, {.maxSpeed = speed-30, .minSpeed = 10, .earlyExitRange = 1});
  chassisWithGoal.moveToPoint(48, 48, 1500, {.maxSpeed = speed1 + 30, .minSpeed = 15, .earlyExitRange = 2}, false);
  turnToHeadingWithVis(45, 1500, 30, {.maxSpeed = speed1});
  intake_anti_jam.suspend();
  moveToPointWithVis(65, 65, 1100, {.maxSpeed = speed1-10, .driveThrough = true});
  pressure.suspend();
  pressure.remove();
  liftPickup();
  chassisWithGoal.moveToPoint(48, 48, 1500, {.forwards = false, .maxSpeed = speed1, .minSpeed = 25, .earlyExitRange = 2});
  ///////////WALL STAKE////////////////
  chassisWithGoal.turnToPoint(47, 24, 1500, {.forwards = false, .maxSpeed = speed, .minSpeed = 15, .earlyExitRange = 2});
  chassisWithGoal.moveToPoint(47, 24, 1500, {.forwards = false, .maxSpeed = speed1, .minSpeed = 15, .earlyExitRange = 2});
  stopIntake();
  pros::Task lift ([=] {moveLiftToPos(400, 127, 1200);});    
  chassisWithGoal.turnToPoint(75.5, 0, 1500, {.maxSpeed = speed, .minSpeed = 5, .earlyExitRange = 1});
  pros::Task lift1 ([=] {
      moveLiftToPos(380, 127, 1200);
      setLiftBrake(pros::E_MOTOR_BRAKE_COAST);
    });
  //chassisWithGoal.moveToPoint(60.75,12,1000,{.maxSpeed = speed1-15}, false);
  printPosition((char *) "Ending stake");
}

void redPositiveWPStake(){//PATH DONE  
  int time = pros::millis();
  int speed = 90;
  float speed1 = float(speed);
  lemlib::Pose temp_pos = chassis.getPose();
  ...
  temp_pos = chassis.getPose();
  chassis.moveToPoint(22, -52, 1000,{.forwards = false, .maxSpeed = 127});
  chassis.turnToHeading(-60, 1000,{.maxSpeed = speed,.minSpeed = 20, .earlyExitRange = 2});
  moveToReset(127);
  pros::Task pressure([=] {
    while(autoLift){
      spinLift(-30);
  ...
  chassisWithGoal.turnToHeading(90, 400,{.maxSpeed = 127,.minSpeed = 25, .earlyExitRange = 2}, false);
  /////////////THIRD RING/////////////
  moveToPointWithVis(46, -22, 2000, {.maxSpeed = 80, .xLimit = 34, .yLimit = -26, .driveThrough = true, .keepDriving = false});
  chassisWithGoal.moveToPoint(55,-22,1000,{.maxSpeed = speed1 - 15,.minSpeed=25,.earlyExitRange=2}, false);
  ////////////CORNER RINGS/////////////
  chassisWithGoal.turnToPoint(52, -49, 1500, {.maxSpeed = speed-30, .minSpeed = 10, .earlyExitRange = 1});
  chassisWithGoal.moveToPoint(52, -49, 1500, {.maxSpeed = speed1 + 30, .minSpeed = 15, .earlyExitRange = 2}, false);
  pros::delay(400);
  chassisWithGoal.turnToPoint(77, -72, 1500, {.maxSpeed = speed, .minSpeed = 15, .earlyExitRange = 1}, false);
  intake_anti_jam.suspend();
  moveToPointWithVis(68, -70, 1100, {.maxSpeed = speed1 - 10, .driveThrough = true});
  liftPickup();
  chassisWithGoal.moveToPoint(48, -48, 1500, {.forwards = false, .maxSpeed = speed1, .minSpeed = 25, .earlyExitRange = 2});
  ///////////WALL STAKE////////////////
  chassisWithGoal.turnToPoint(53, -24, 1500, {.forwards = false, .maxSpeed = speed, .minSpeed = 15, .earlyExitRange = 2});
  chassisWithGoal.moveToPoint(53, -24, 1500, {.forwards = false, .maxSpeed = speed1, .minSpeed = 15, .earlyExitRange = 2});
  stopIntake();
  pros::Task lift ([=] {moveLiftToPos(420, 127, 1200);});    
  chassisWithGoal.turnToPoint(74, 0, 1500, {.maxSpeed = speed, .minSpeed = 15, .earlyExitRange = 2});
  pros::Task lift1 ([=] {moveLiftToPos(380, 127, 1200);});    
  chassisWithGoal.moveToPoint(68,-9,1000,{.maxSpeed = speed1-15, .minSpeed = 15});
}
...
void bluePositiveWPGoal(){
  ...
  chassis.moveToPoint(52,48,1500,{.maxSpeed = speed1}, false); 
...
void bluePosSmart() {
  ...
  bool goalPath = true;
  temp_pos = chassis.getPose();
  float dist = distToObject() - 10.36;
  if(fabs(temp_pos.y + dist * cos(deg2rad(temp_pos.theta))) < 7){
    goalPath = false;
  }

  /***************MIDDLE GOAL PATH**************/
  if(goalPath){
    chassis.moveToPoint(temp_pos.x+(dist * sin(deg2rad(temp_pos.theta))),  temp_pos.y+(dist * cos(deg2rad(temp_pos.theta))) , 700, {.maxSpeed=70,.minSpeed=25,.earlyExitRange=2}, false);
    moveLiftToPos(520, 127, 400);
    chassis.turnToHeading(135, 1500, {.maxSpeed = speed, .minSpeed=5, .earlyExitRange=1}, false);
    temp_pos = chassis.getPose();
    chassis.moveToPoint(temp_pos.x+(-5 * sin(deg2rad(temp_pos.theta))),  temp_pos.y+(-5 * cos(deg2rad(temp_pos.theta))) , 700,{.forwards = false, .maxSpeed=speed1,.minSpeed=25,.earlyExitRange=2});
    chassis.turnToPoint(48, 24, 1500, {.forwards = false, .maxSpeed = speed, .minSpeed = 5, .earlyExitRange = 1});
    chassis.moveToPoint(48, 24, 1500, {.forwards = false, .maxSpeed = speed1, .minSpeed = 15, .earlyExitRange = 2});
  }
  ...
  /***************AWS STAKE RING**************/
  chassis.turnToPoint(0, 48, 1500, {.maxSpeed = speed,.minSpeed=5,.earlyExitRange=1});
  moveToPointWithVis(0, 48, 2000, {.maxSpeed = speed1 - 20, .xLimit = 10}, 600);
  /***************TOUCH LADDER**************/
  chassis.moveToPoint(24, 48, 1000, {.forwards = false, .maxSpeed = speed1, .minSpeed=25, .earlyExitRange=2});
  chassis.turnToPoint(12, 12, 1000, {.maxSpeed = speed, .minSpeed=5, .earlyExitRange=1});
  chassis.moveToPoint(14, 24, 1000, {.maxSpeed = speed1, .minSpeed=40, .earlyExitRange=2});
...
void redPosSmart() {
  ...
  pros::delay(300);
  intake_anti_jam.suspend();
  chassisWithGoal.moveToPoint(55,-24,1000,{.maxSpeed = speed1 - 15,.minSpeed=25,.earlyExitRange=2});
  stopIntake();
  liftUpWallStake();
  pros::delay(100);
  spinIntake(127);
  turnToHeadingWithVisGoal(0,4000,30);
  temp_pos = chassisWithGoal.getPose();
  float dist = distToObject();
  if((temp_pos.y + (dist * cos(temp_pos.theta))) < 3.3){
    chassisWithGoal.moveToPoint(temp_pos.x+((dist - 10.75) * sin(deg2rad(temp_pos.theta))),  temp_pos.y+((dist - 10.75) * cos(deg2rad(temp_pos.theta))) , 700,{.maxSpeed=speed1,.minSpeed=25,.earlyExitRange=2},false);
  }
  ////////////MIDDLE GOAL CHECK/////////////
...
void RedGoalRushWallStake()
{

}
void BlueGoalRushWallStake()
{
  // int time = pros::millis();
  // int speed = 127;
  // float speed1 = float(speed);
  ...
  // chassis.setPose(36.85,52.045,171.5);
  // chassis.moveToPoint(49.5, 11.5, 2000,{.maxSpeed = speed1, .minSpeed = 30,.earlyExitRange = 4});
  // pros::Task goalrush([=] {moveLiftToPos(450,127,1500);});
  // pros::delay(100);
  // spinIntake(127);
  // pros::Task save_ring([=] {saveRing(4000);}); 
  // chassis.turnToHeading(185,500,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  // chassis.waitUntilDone();
  // pros::Task goalrush1([=] {moveLiftToPos(700,127,1500);});

  // chassis.moveToPoint(48, 24, 2000,{.forwards =false, .maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  // chassis.turnToHeading(235,900,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  // chassis.turnToPoint(24, 24, 1000,{.forwards=false,.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  // chassis.moveToPoint(24, 24, 2000,{.forwards =false, .maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  // moveToReset();
  // chassis.waitUntilDone();
  // closeClamp();
  // chassis.cancelAllMotions();
  // chassisWithGoal.setPose(chassis.getPose());  
  int time = pros::millis();
  int speed = 127;
  float speed1 = float(speed);
  lemlib::Pose temp_pos = chassis.getPose();
  ...
  chassis.setPose(48,58,180);
  chassis.moveToPoint(47.6, 13, 1800,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  pros::Task goalrush([=] {moveLiftToPos(460,127,1500);});
  pros::delay(100);
  spinIntake(127);
  pros::Task save_ring([=] {saveOurRing1(4000);}); 
  chassis.moveToPoint(48, 36, 2000,{.forwards =false, .maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  moveLiftToPos(850,127,600);
  pros::delay(500);
  chassis.turnToHeading(295,900,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassis.turnToPoint(24, 24, 1000,{.forwards=false,.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassis.moveToPoint(24, 24, 2000,{.forwards =false, .maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  moveToReset();
  chassis.waitUntilDone();
  ...
  chassisWithGoal.setPose(chassis.getPose()); 
  spinIntake();
  chassis.turnToPoint(0, 0, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassis.moveToPoint(8, 7, 2000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  chassis.waitUntilDone();
  extendLeftSweeper();
...
void goalRushWallStake(){
  if(COLOR){
    RedGoalRushWallStake();
  } else {
    BlueGoalRushWallStake();
  }
}
...
void redNegativeHalfWP(){//PATH DONE
  ...
  temp_pos = chassis.getPose();
  chassis.moveToPoint(-22, -54, 1500,{.forwards = false, .maxSpeed = 127,.minSpeed=30,.earlyExitRange=3});
  chassis.turnToHeading(90, 1000,{.maxSpeed = speed,.minSpeed = 15, .earlyExitRange = 2});
  pros::Task pressure([=] {
    moveToReset(127);
    while(autoLift){
      spinLift(-30);
  ...
  spinIntake(127);
  startSorting();
  chassis.moveToPoint(-24,-25.5,1500,{.forwards=false,.maxSpeed = speed1,.minSpeed = 5, .earlyExitRange = 1}, false);
  closeClamp();
  printPositionV2((char *) "sweeper", false, false, time);
  chassis.cancelAllMotions();
  chassisWithGoal.setPose(chassis.getPose());
  printPosition((char *) "At goal");
  pros::delay(280);
  spinIntake(127);
  startSorting();
  ///////////////MIDLINE RINGS////////////
  ...
  retractLeftSweeper();
  printPositionV2((char *) "sweeper", false, false, time);
  chassisWithGoal.moveToPose(-46.5,-7, -55, 1500,{.maxSpeed = speed1, .minSpeed=30}, false);
  printPosition((char *) "Approach Ring1");
  chassisWithGoal.moveToPoint(-59,-7.5,1500,{.maxSpeed = 114,.minSpeed = 10, .earlyExitRange = 1}, false);
  printPosition((char *) "Approach Ring2");
  pros::delay(500); 
  chassisWithGoal.turnToPoint(-60, -48, 1500, {.maxSpeed = speed, .minSpeed = 10, .earlyExitRange = 2});
  /////////////////THIRD RING/////////////
  chassisWithGoal.moveToPose(-55, -26, 135, 1500, {.maxSpeed = speed1, .minSpeed = 15, .earlyExitRange = 2});
  chassisWithGoal.swingToHeading(80, lemlib::DriveSide::LEFT, 1500, {.maxSpeed = speed1, .minSpeed = 15, .earlyExitRange = 2}, false);
  printPositionV2((char *) "sweeper", false, false, time);
  ...
  chassisWithGoal.moveToPoint(-14,-15,2000,{.maxSpeed=speed1,.minSpeed= 5,.earlyExitRange=1}, false);
...
void blueNegativeHalfWP(){
  ...
  temp_pos = chassis.getPose();
  chassis.moveToPoint(-22, 52, 1000,{.forwards = false, .maxSpeed = 127});
  chassis.turnToHeading(127, 1000,{.maxSpeed = speed,.minSpeed = 20, .earlyExitRange = 2});
  pros::Task pressure([=] {
    moveToReset(127);
    while(autoLift){
      spinLift(-30);
  ...
  chassis.moveToPoint(-18, 50.5, 1000,{.maxSpeed = 127,.minSpeed = 50,.earlyExitRange=0.25},false);
  extendLeftSweeper();
  printPosition((char *) "Sweeper");
  pros::delay(200);
  // chassis.turnToHeading(0, 1500, {.maxSpeed = speed, .minSpeed = 15, .earlyExitRange = 1});
  // chassis.moveToPoint(-17, 52, 1500, {.maxSpeed = 60, .minSpeed = 5, .earlyExitRange = 1});
  /////////////GOAL GRAB////////////
  chassis.turnToPoint(-26,20,1500,{.forwards=false,.maxSpeed = speed,.minSpeed = 5, .earlyExitRange = 1});
  chassis.moveToPoint(-26,20,1500,{.forwards=false,.maxSpeed = speed1,.minSpeed = 5, .earlyExitRange = 1},false);
  spinIntake(127);
  startSorting();
  closeClamp();
  chassis.cancelAllMotions();
  ...
  startSorting();
  ///////////////MIDLINE RINGS////////////
  chassisWithGoal.turnToHeading(250, 1000,{.maxSpeed=speed,.minSpeed=5,.earlyExitRange=1}, false);
  pros::delay(50);
  retractLeftSweeper();
  chassisWithGoal.moveToPose(-46.5,7.25, 245, 1500,{.maxSpeed = speed1, .minSpeed=30}, false);
  printPosition((char *) "Approach Ring1");
  pros::delay(300);
  chassisWithGoal.moveToPoint(-60,7.5,1500,{.maxSpeed = speed1,.minSpeed = 10, .earlyExitRange = 1}, false);
  printPosition((char *) "Approach Ring2");
  pros::delay(400);
  chassisWithGoal.turnToPoint(-58, 48, 1500, {.maxSpeed = speed, .minSpeed = 10, .earlyExitRange = 2});
  /////////////////THIRD RING/////////////
  chassisWithGoal.moveToPose(-55, 20, 45, 1500, {.maxSpeed = speed1, .minSpeed = 15, .earlyExitRange = 2});
  chassisWithGoal.swingToHeading(93, lemlib::DriveSide::RIGHT, 1500, {.maxSpeed = speed1, .minSpeed = 15, .earlyExitRange = 2}, false);
  /***************TOUCH LADDER**************/
  chassisWithGoal.turnToPoint(-0,0,1000,{.maxSpeed=speed,.minSpeed=15,.earlyExitRange=1});
  chassisWithGoal.moveToPoint(-17,17,2000,{.maxSpeed=speed1,.minSpeed= 5,.earlyExitRange=1}, false);
...
void redNegHalfWPWallStake() {//PATH DONE 
  ...
  pros::Task intake_anti_jam(intakeAntiJamTaskFunc);
  pros::Task reset_lift_pos(resetLiftWithDistTaskFunc);  
  chassis.moveToPoint(-13, -58.5, 1000,{.maxSpeed=speed1,.minSpeed=20,.earlyExitRange=1});
  chassis.waitUntil(5);
  moveLiftToPos(660, 127, 800);
  temp_pos = chassis.getPose();
  chassis.moveToPoint(-22, -54, 1500,{.forwards = false, .maxSpeed = 127,.minSpeed=30,.earlyExitRange=3});
  ...
  spinIntake(127);
  startSorting();
  chassis.moveToPoint(-24,-25.5,900,{.forwards=false,.maxSpeed = speed1,.minSpeed = 5, .earlyExitRange = 1}, false);
  closeClamp();
  printPositionV2((char *) "sweeper", false, false, time);
  chassis.cancelAllMotions();
  chassisWithGoal.setPose(chassis.getPose());
  ...
  retractLeftSweeper();
  printPositionV2((char *) "sweeper", false, false, time);
  chassisWithGoal.moveToPose(-45.5,-7.25, -65, 1500,{.maxSpeed = speed1, .minSpeed=30}, false);
  pros::delay(300);
  printPosition((char *) "Approach Ring1");
  chassisWithGoal.moveToPoint(-58,-7.8,1500,{.maxSpeed = 105,.minSpeed = 10, .earlyExitRange = 1}, false);
  pros::delay(200); 
  // saveOurRing1(400);
  printPosition((char *) "Approach Ring2");
  chassisWithGoal.turnToPoint(-58, -48, 1500, {.maxSpeed = speed, .minSpeed = 10, .earlyExitRange = 2});
  /////////////////THIRD RING/////////////
  chassisWithGoal.moveToPose(-52, -20, 135, 1500, {.maxSpeed = speed1, .minSpeed = 15, .earlyExitRange = 2});
  spinIntake();
  chassisWithGoal.swingToHeading(80, lemlib::DriveSide::LEFT, 1500, {.maxSpeed = speed1, .minSpeed = 15, .earlyExitRange = 2}, false);
  pros::delay(300);
  printPositionV2((char *) "sweeper", false, false, time);
  ...
  chassisWithGoal.moveToPoint(-47, -24, 1500, {.forwards = false, .maxSpeed = speed1, .minSpeed = 15, .earlyExitRange = 2});
  pros::delay(100);
  moveLiftToPos(31, 100, 1200);
  chassisWithGoal.waitUntil(1000);
  stopIntake();
  moveLiftToPos(400, 127, 1200);
  chassisWithGoal.turnToPoint(-75.5, 0, 1500, {.maxSpeed = speed, .minSpeed = 5, .earlyExitRange = 1});
  pros::delay(100);
  pros::Task ws_task([=]{
    moveLiftToPos(375, 127, 1200);
    setLiftBrake(pros::E_MOTOR_BRAKE_COAST);
  });
  spinIntake();
  chassisWithGoal.moveToPoint(-63,-11.25,1000,{.maxSpeed = speed1-15}, false);
  printPosition((char *) "Ending stake");


}

void blueNegHalfWPWallStake() {
  int time = pros::millis();
  int speed = 80;
  float speed1 = float(speed);
  COLOR = false;
  ...
  temp_pos = chassis.getPose();
  chassis.moveToPoint(-22, 52, 1000,{.forwards = false, .maxSpeed = 127});
  chassis.turnToHeading(124, 1000,{.maxSpeed = speed,.minSpeed = 20, .earlyExitRange = 2});
  pros::Task pressure([=] {
    moveToReset(127);
    while(autoLift){
      spinLift(-30);
  ...
  /////////////GOAL GRAB////////////
  chassis.turnToPoint(-26,20,1500,{.forwards=false,.maxSpeed = 70,.minSpeed = 5, .earlyExitRange = 1});
  chassis.moveToPoint(-26.5,20,1500,{.forwards=false,.maxSpeed = 70,.minSpeed = 5, .earlyExitRange = 1},false);
  spinIntake(127);
  startSorting();
  closeClamp();
  chassis.cancelAllMotions();
  ...
  moveLiftToPos(31, 100, 1200);
  /////////////////WALL STAKE/////////////
  chassisWithGoal.moveToPoint(-47.25, 24, 1500, {.maxSpeed = speed1, .minSpeed = 15, .earlyExitRange = 2}, false);
  stopIntake();
  moveLiftToPos(400, 127, 1200);
  chassisWithGoal.turnToPoint(-75.5, 0, 1500, {.maxSpeed = speed, .minSpeed = 5, .earlyExitRange = 1});
  pros::delay(100);
  ...
  spinIntake();
  chassisWithGoal.moveToPoint(-63.5,10,1000,{.maxSpeed = speed1-15}, false);
  printPosition((char *) "Ending stake");
}
...
void redNegSixRing(){ 
  ...
  pros::Task intake_anti_jam(intakeAntiJamTaskFunc);
  pros::Task reset_lift_pos(resetLiftWithDistTaskFunc);  
  chassis.moveToPoint(-13, -58, 1000,{.maxSpeed=speed1 + 10,.minSpeed=15,.earlyExitRange=1});
  chassis.waitUntil(5);
  moveLiftToPos(660, 127, 800);
  temp_pos = chassis.getPose();
  chassis.moveToPoint(-22, -54, 1500,{.forwards = false, .maxSpeed = 127,.minSpeed=30,.earlyExitRange=3});
  chassis.turnToHeading(90, 1000,{.maxSpeed = speed + 10,.minSpeed = 15, .earlyExitRange = 2});
  pros::Task pressure([=] {
    moveToReset(127);
    while(autoLift){
      spinLift(-30);
  ...
  startSorting();
  ///////////////MIDLINE RINGS////////////
  chassisWithGoal.turnToHeading(290, 1000,{.maxSpeed=speed,.minSpeed=5,.earlyExitRange=1}, false);
  pros::delay(50);
  retractLeftSweeper();
  printPositionV2((char *) "sweeper", false, false, time);
  chassisWithGoal.moveToPose(-47,-7.2, -65, 1500,{.maxSpeed = speed1, .minSpeed=30}, false);
  printPosition((char *) "Approach Ring1");
  chassisWithGoal.moveToPoint(-59,-8,1500,{.maxSpeed = 110,.minSpeed = 10, .earlyExitRange = 1}, false);
  printPosition((char *) "Approach Ring2");
  pros::delay(150); 
  chassisWithGoal.turnToPoint(-58, -48, 1500, {.maxSpeed = 127, .minSpeed = 10, .earlyExitRange = 2});
  /////////////////THIRD RING/////////////
  chassisWithGoal.moveToPose(-52, -26, 135, 1500, {.maxSpeed = 127, .minSpeed = 15, .earlyExitRange = 2});
  chassisWithGoal.swingToHeading(86, lemlib::DriveSide::LEFT, 1500, {.maxSpeed = 127, .minSpeed = 35, .earlyExitRange = 2}, false);
  printPositionV2((char *) "sweeper", false, false, time);
  moveToPointWithVis(-24, -24, 1500, {.maxSpeed = speed1 - 10, .xLimit = -24, .yLimit = -32, .driveThrough = false, .keepDriving = true});
  ////////////CORNER RINGS/////////////
  chassisWithGoal.turnToPoint(-53, -48, 1500, {.maxSpeed = speed-30, .minSpeed = 10, .earlyExitRange = 1});
  chassisWithGoal.moveToPoint(-53, -48, 1500, {.maxSpeed = speed1+30, .minSpeed = 15, .earlyExitRange = 2}, false);
  pros::delay(200);
  chassisWithGoal.turnToPoint(-72, -75, 1500, {.maxSpeed = 127, .minSpeed = 15, .earlyExitRange = 1}, false);
  intake_anti_jam.suspend();
  moveToPointWithVis(-68, -70, 1200, {.maxSpeed = speed1 - 10, .driveThrough = true});
  /***************TOUCH LADDER**************/
  chassisWithGoal.moveToPoint(-16,-17,2000,{.forwards = false, .maxSpeed=127,.minSpeed= 15,.earlyExitRange=2});
  chassisWithGoal.waitUntil(15);
  stopIntake();
  chassisWithGoal.waitUntil(100);
...
void blueNegSixRing(){
  ...
  temp_pos = chassis.getPose();
  chassis.moveToPoint(-22, 52, 1000,{.forwards = false, .maxSpeed = 127});
  chassis.turnToHeading(120, 1000,{.maxSpeed = speed,.minSpeed = 20, .earlyExitRange = 2});
  pros::Task pressure([=] {
    moveToReset(127);
    while(autoLift){
      spinLift(-30);
  ...
  // chassis.moveToPoint(-17, 52, 1500, {.maxSpeed = 60, .minSpeed = 5, .earlyExitRange = 1});
  /////////////GOAL GRAB////////////
  chassis.turnToPoint(-26,20,1500,{.forwards=false,.maxSpeed = speed,.minSpeed = 8, .earlyExitRange = 1});
  chassis.moveToPoint(-26,20,1500,{.forwards=false,.maxSpeed = speed1,.minSpeed = 8, .earlyExitRange = 1},false);
  spinIntake(127);
  startSorting();
  closeClamp();
  chassis.cancelAllMotions();
  ...
  pros::delay(50);
  retractLeftSweeper();
  chassisWithGoal.moveToPose(-46.5,7, 245, 1500,{.maxSpeed = 70, .minSpeed=30}, false);
  printPosition((char *) "Approach Ring1");
  pros::delay(250);
  chassisWithGoal.moveToPoint(-60,7.5,1500,{.maxSpeed = 70,.minSpeed = 10, .earlyExitRange = 1}, false);
  printPosition((char *) "Approach Ring2");
  pros::delay(250);
  chassisWithGoal.turnToPoint(-58, 48, 1500, {.maxSpeed = 70, .minSpeed = 10, .earlyExitRange = 2});
  /////////////////THIRD RING/////////////
  chassisWithGoal.moveToPose(-55, 20, 45, 1500, {.maxSpeed = 70, .minSpeed = 15, .earlyExitRange = 2});
  chassisWithGoal.swingToHeading(93, lemlib::DriveSide::RIGHT, 1500, {.maxSpeed = 70, .minSpeed = 15, .earlyExitRange = 2}, false);
  pros::delay(200);
  /////////////////THIRD RING/////////////
  chassisWithGoal.turnToPoint(-48, 48, 1500, {.maxSpeed = speed - 20, .minSpeed = 10, .earlyExitRange = 1});
  chassisWithGoal.moveToPoint(-48, 45, 1500, {.maxSpeed = speed1, .minSpeed = 25, .earlyExitRange = 2});
  chassisWithGoal.turnToPoint(-72, 72, 1500, {.maxSpeed = speed + 20, .minSpeed = 15, .earlyExitRange = 1}, false);
  moveToPointWithVis(-72, 72, 2000, {.maxSpeed = 90, .driveThrough = true});
  ////////////////TOUCH LADDER////////////////
  //chassisWithGoal.turnToPoint(-0,0,1000,{.maxSpeed=speed,.minSpeed=15,.earlyExitRange=1});
  chassisWithGoal.moveToPoint(-18,15,2000,{.forwards = false, .maxSpeed=127,.minSpeed= 15,.earlyExitRange=1}, false);
  stopIntake();
...
void auton_60s_skills_1() {
  ...
  stopSorting();
  lemlib::Pose temp_pos = chassis.getPose();
  chassis.setPose(0,-61.7,0);
  spinIntake(127);
  pros::delay(500);
  chassis.moveToPoint(0, -48, 1000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  chassis.turnToPoint(-25, -48, 1000,{.forwards=false,.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassis.moveToPoint(-25, -48, 1000,{.forwards=false,.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  chassis.waitUntilDone();
  closeClamp();
  chassis.cancelAllMotions();
  chassisWithGoal.setPose(chassis.getPose());
  ...
  chassisWithGoal.turnToPoint(-27, -25, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassisWithGoal.moveToPoint(-27, -25, 1000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  chassisWithGoal.turnToPoint(-48, 24, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassisWithGoal.moveToPoint(-48, 24, 4000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  chassisWithGoal.turnToPoint(-60, 5, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassisWithGoal.moveToPoint(-60, 5, 4000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  chassisWithGoal.turnToPoint(-48, -48, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassisWithGoal.moveToPoint(-48, -48, 4000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  chassisWithGoal.turnToPoint(-48, -60, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassisWithGoal.moveToPoint(-48, -60, 4000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});

  chassisWithGoal.turnToPoint(-44, -48, 1000,{.forwards = false,.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassisWithGoal.moveToPoint(-44,-48, 4000,{.forwards = false, .maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  chassisWithGoal.turnToPoint(-60, -48, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassisWithGoal.moveToPoint(-60,-48, 4000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  pros::Task save_ring([=] {saveRing();}); 
  chassisWithGoal.turnToPoint(-66, -62, 1000,{.forwards= false,.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassisWithGoal.moveToPoint(-66, -62, 1000,{.forwards = false,.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1},false);
  openClamp();
  chassisWithGoal.cancelAllMotions();
  chassis.setPose(chassisWithGoal.getPose());
  chassis.turnToPoint(-36, 36, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassis.moveToPoint(-36,36, 4000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  chassis.turnToPoint(-26, 50, 1000,{.forwards = false,.maxSpeed = speed-40, .minSpeed = 10,.earlyExitRange = 2});
  chassis.moveToPoint(-26,50, 1300,{.forwards=false,.maxSpeed = speed1-40, .minSpeed = 10,.earlyExitRange = 1});
  chassis.waitUntilDone();
  closeClamp();
  chassis.cancelAllMotions();
  chassisWithGoal.setPose(chassis.getPose());
  pros::delay(100);
  // chassisWithGoal.turnToPoint(-34, 54, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  // chassisWithGoal.moveToPoint(-34,54, 4000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  // extendLeftSweeper();
  // chassisWithGoal.turnToPoint(-60, 25, 1000,{.maxSpeed = speed, .minSpeed = 50,.earlyExitRange = 4});
  // chassisWithGoal.turnToPoint(0, 0, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassisWithGoal.turnToPoint(-57,62, 1500,{.forwards= false,.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 1});
  chassisWithGoal.moveToPoint(-57,62, 1500,{.forwards= false,.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1},false);
  openClamp();
  retractLeftSweeper();
  chassisWithGoal.cancelAllMotions();
  chassis.setPose(chassisWithGoal.getPose());
  pros::delay(100);
  chassis.turnToPoint(-24, 45, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassis.moveToPoint(-24,45, 4000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  chassis.turnToPoint(0, 44, 1000,{.forwards=false,.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassis.moveToPoint(0,44, 1500,{.forwards=false,.maxSpeed = speed1-40, .minSpeed = 2,.earlyExitRange = 0.1});
  chassis.waitUntilDone();//*/
  closeClamp();
  chassis.cancelAllMotions();
  chassisWithGoal.setPose(chassis.getPose());
  chassisWithGoal.turnToPoint(-22, 22, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  spinIntake();
  chassisWithGoal.moveToPoint(-22,22, 4000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  chassisWithGoal.turnToPoint(1, -1, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2},false);
  pros::delay(750);
  chassisWithGoal.moveToPoint(2,-2, 2000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1},false);
  pros::delay(750);
  chassisWithGoal.turnToPoint(23, -23, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassisWithGoal.moveToPoint(23,-23, 4000,{.maxSpeed = speed1, .minSpeed = 50,.earlyExitRange = 5});
  chassisWithGoal.turnToPoint(45, -48, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassisWithGoal.moveToPoint(45,-48, 4000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  chassisWithGoal.turnToPoint(45, -66, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassisWithGoal.moveToPoint(45,-66, 4000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  chassisWithGoal.turnToPoint(55, -70, 1000,{.forwards=false,.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassisWithGoal.moveToPoint(55,-70, 2000,{.forwards=false,.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1},false);
  openClamp();
  chassisWithGoal.cancelAllMotions();
  chassis.setPose(chassisWithGoal.getPose());
  chassis.turnToPoint(36, -48, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassis.moveToPoint(36,-48, 4000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  chassisWithGoal.turnToPoint(24, -48, 1000,{.forwards=false,.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassisWithGoal.moveToPoint(24,-48, 2000,{.forwards=false,.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  chassis.waitUntilDone();//*/
  closeClamp();
  chassis.cancelAllMotions();
  chassisWithGoal.setPose(chassis.getPose());
  chassisWithGoal.moveToPoint(60,-48, 2000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  chassisWithGoal.turnToPoint(48, -24, 1000,{.forwards=false,.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassisWithGoal.moveToPoint(48,-24, 2000,{.forwards=false,.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});

  return;
  chassis.turnToPoint(0, -48, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassis.moveToPoint(0,-48, 4000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  chassis.turnToPoint(25, -48, 1000,{.maxSpeed = speed, .minSpeed = 10,.earlyExitRange = 2});
  chassis.moveToPoint(25,-48, 4000,{.maxSpeed = speed1, .minSpeed = 10,.earlyExitRange = 1});
  chassis.waitUntilDone();
  closeClamp();
  chassis.cancelAllMotions();
  chassisWithGoal.setPose(chassis.getPose());
