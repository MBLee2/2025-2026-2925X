...
void blankAuton() {
  ...
  chassis.moveToPoint(0, 50, 15000);
}
...
void topWP() {
  ...
  chassis.moveToPoint(-25, -24, 2000, {.maxSpeed = speed - 60});
  chassis.turnToPoint(2, 0, 2000, {.forwards = false, .maxSpeed = tspeed});
  stopAllIntake();
  chassis.moveToPoint(-13.5, -16.5, 2000, {.forwards = false, .maxSpeed = speed}, false);
  stopperDown();
  pros::delay(100);
  intakeAll(100);
  setScoringTrue();
  ...
  chassis.moveToPoint(-40, -48, 2000, {.maxSpeed = speed});
  stopperUp();
  goalUp();
  extendLoader();
  chassis.turnToHeading(180, 2000, {.maxSpeed = tspeed});
  chassis.moveToPoint(-40, -63, 2000, {.maxSpeed = speed - 30}, false);
  pros::delay(1000);
  stopAllIntake();
  chassis.moveToPoint(-44, -32, 1500, {.forwards = false, .maxSpeed = speed - 40}, false);
  stopperDown();
  setScoringTrue();
  pros::delay(15000);
...
void auton_60s_skills_1() {
  ...
  extendLoader();
  chassis.moveToPoint(chassis.getPose().x, 63, 2000, {.maxSpeed = speed});
  count_blocks_in(4, 4000);
  intakeAll(70);
  count_blocks_in(2, 2000);
  chassis.moveToPoint(48, 32, 2000, {.forwards = false, .maxSpeed = speed}, false);
  intakeAll(127);
