...
std::vector<auton_menu_button> button_list = {
    ...
    auton_menu_button{{245, 115, 345, 165, pros::c::COLOR_DIM_GRAY,
                       pros::c::COLOR_WHITE_SMOKE, "Neg6+Stake", pros::E_TEXT_MEDIUM},
                      negetive_6_ring_wall_stake},
    auton_menu_button{{360, 115, 460, 165, pros::c::COLOR_DIM_GRAY,
                       pros::c::COLOR_WHITE_SMOKE, "Neg6both", pros::E_TEXT_MEDIUM},
                       negetive_6_ring_both_stake},
