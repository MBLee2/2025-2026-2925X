...
{
    // Near driver autons
    auton_menu_button {{ 15, 50, 115, 100, COLOR_DIM_GRAY, COLOR_WHITE_SMOKE, "Nr Qual", pros::E_TEXT_MEDIUM }, near_driver_qual},
    auton_menu_button {{130, 50, 230, 100, COLOR_DIM_GRAY, COLOR_WHITE_SMOKE, "Nr Elim", pros::E_TEXT_MEDIUM }, near_driver_elim},
  //  auton_menu_button {{245, 50, 345, 100, COLOR_DIM_GRAY, COLOR_WHITE_SMOKE, "NEAR 3", pros::E_TEXT_MEDIUM },  },
  ...
  //  auton_menu_button {{245, 115, 345, 165, COLOR_DARK_GRAY, COLOR_WHITE_SMOKE, "FAR 3", pros::E_TEXT_MEDIUM },  },
  //  auton_menu_button {{360, 115, 460, 165, COLOR_DARK_GRAY, COLOR_WHITE_SMOKE, "FAR 4", pros::E_TEXT_MEDIUM },  },
    // Skills autons
    auton_menu_button {{ 15, 180, 230, 230, COLOR_BEIGE, COLOR_WHITE_SMOKE, "SKILLS 1", pros::E_TEXT_MEDIUM },  skills_1},
    auton_menu_button {{245, 180, 460, 230, COLOR_BEIGE, COLOR_WHITE_SMOKE, "SKILLS 2", pros::E_TEXT_MEDIUM },  skills_2}
};
